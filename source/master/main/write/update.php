        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="module_small">
                    ...
                    <input type="text" name="type" class="textbox3" id="type" value="<?php echo $row['type']?>">
                    <br>
                    <label for="title">제목</label>
                    <input type="text" name="title" class="textbox4" id="title" value="<?php echo $row['title']?>">
                </div>
                <br>
                <div class="module_small">
                    <textarea class="textarea1" name="content" id="content"><?php echo $row['content']?></textarea>
                </div>
                <br>
                <div class="module_small">
