        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <tr>
                    ...
                    <td><a href="out.php?snum=<?php echo $row['snum']?>"><button class="button2">삭제</button></a></td> 
                </tr>
                ...
                <br>
                <div class="module_small">
                    <button class="button3" onclick="window.open('plus.php','window_name','width=430,height=300,location=no,status=no,scrollbars=yes');">학생 추가</button>
                    <p style="display: inline;">신입생, 전학생 등 학생을 추가합니다.</p>
                </div>
            </div>
        </div>
    </body>
