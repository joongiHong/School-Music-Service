...
#### 3. 자동 생성 서비스를 통한 설치
본 서비스는 간편한 설치 서비스를 제공합니다.<br>
'귀하의 웹주소'/setup 으로 이동하신 뒤에 안내에 따라<br>
각종 정보를 입력하신 뒤에 성공 메시지가 표시되면 7단계 각종 정보 변경 단계부터 진행하시면 됩니다.

#### 4. mysql 테이블 생성
※ 본 4단계 부터는 3단계 자동 서비스를 통해 설치하지 못한경우 따라주시기 바랍니다. ※<br><br>
